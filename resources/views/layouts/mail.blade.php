        ...
        <tr><!-- Outer Table -->
            <td align="center" bgcolor="#f0f0f0" data-composer>
                ...
                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                    <!-- lotus-header-1 -->
                    <tr>
                        <td align="center" bgcolor="{{ config('pleb.custom.header_content.bgcolor') }}" class="container-padding">
                                                    ...
                                                    <table border="0" align="right" cellpadding="0" cellspacing="0" role="presentation" class="row" width="280" style="width:280px;max-width:280px;">
                                                        <tr>
                                                            <td align="left" class="center-text">
                                                                <a href="{{ env('APP_URL_FRONTEND') }}"><img style="width:72px;border:0px;display: inline!important; border-radius: 50%;" src="{{ config('pleb.mail.top_logo') }}" width="72" border="0" alt="logo"></a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- column -->
                            ...
                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                                                            ...
                                                            <td class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                                ...
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td width="10"></td>
                                                                        <td align="center">
                                                                            <a href="{{ config('pleb.mail.twitter_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('assets/img/emails/X-social.png') }}" width="36" border="0" alt="icon"></a>
                                                                        </td>
                                                                        <td width="10"></td>
                                                                    </tr>
                                                                </table>
                                ...
                                <tr>
                                    <td class="center-text" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                        ...
                                        <a href="mailto:{{ config('pleb.mail.info_email') }}" style="color:#6e6e6e;"><span>{{ config('pleb.mail.info_email') }}</span></a> - <a href="{{ env('APP_URL_FRONTEND') }}" style="color:#6e6e6e;"><span>{{ env('APP_URL_FRONTEND') }}</span></a>
                                                    ...
                                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                        <tr>
                                                            <td align="start">
                                                                ...
                                                                {!!  str_replace('@url_not_mails',env('APP_URL_FRONTEND'). '/not/mails',str_replace('@mail',env('MAIL_CONTACT_EMAIL'),__('pleb.mail.Remember email'))) !!}
                                                                
                                                                {{ __('pleb.mail.Email not reply') }}
